...
extern int              jb_unsandbox_now            (jb_connection_t connection, pid_t pid);
...
extern void             jb_oneshot_unsandbox        (pid_t pid, jb_callback_t callback);
...
extern int              jb_oneshot_unsandbox_now    (pid_t pid);
